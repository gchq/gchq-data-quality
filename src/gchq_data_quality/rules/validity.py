...
class ValidityRegexBaseRule(BaseRule):
    r"""
    Base rule for validating string values against a regular expression.
...
class ValidityRegexRule(ValidityRegexBaseRule):
    r"""
...
class ValuesMatchRegex(ValidityRegexBaseRule):
    r"""
    Rule for validating string values against a regular expression.
...
class ValidityNumericalRangeBaseRule(BaseRule):
    """
    Base rule for validating numerical values against a specified range.
...
class ValuesMatchNumericalRange(ValidityNumericalRangeBaseRule):
    """
    Rule for validating numerical values against a specified range.
