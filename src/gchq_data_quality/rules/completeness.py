...
class CompletenessBaseRule(BaseRule):
    """
    Base rule to calculate the completeness score for a field.
...
class CompletenessRule(CompletenessBaseRule):
    """
...
class ValuesAreComplete(CompletenessBaseRule):
    """
    Rule to calculate the completeness score for a field.
